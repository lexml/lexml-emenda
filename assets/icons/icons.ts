...
<svg class="icon-comentario-plus" id="comentario-plus" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
  <path
    class="ql-fill"
    fill-rule="evenodd"
    d="M 0.58 1.00
  ...
  <path
    class="ql-fill"
    transform="translate(-0.25 -0.25) scale(1.06)"
    d="M 7.85 3.69
       L 7.38 4.15
       L 7.38 6.12
       L 5.38 6.15
