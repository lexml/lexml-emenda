...
@customElement('lexml-emenda-alterar-largura-tabela-coluna-modal')
...
declare global {
  interface HTMLElementTagNameMap {
    'lexml-emenda-alterar-largura-tabela-coluna-modal': AlterarLarguraTabelaColunaModalComponent;
  }
}
