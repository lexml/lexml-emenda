...
export class NotaRodapeModal {
  ...
  constructor(options: { domNodeNotaRodape: HTMLElement; idNotaRodape?: string; textoInicialNotaRodape?: string; tituloModal?: string }) {
    ...
    this.modalElement.classList.add('modal-lexml-emenda-nota-rodape');
    ...
    this.shadowRoot.innerHTML = `
      ...
      <style>
        ...
        .modal-lexml-emenda-nota-rodape {
        ...
        .modal-lexml-emenda-nota-rodape .ql-tooltip input:invalid {
          color: red;
        }

        .modal-lexml-emenda-nota-rodape .ql-tooltip div.tooltip-invalid-message {
          color: red;
          display: none;
          font-family: var(--eta-font-sans);
          font-size: 0.9rem;
        ...
        .modal-lexml-emenda-nota-rodape .ql-tooltip[data-mode='link'] div.tooltip-invalid-message::after {
          content: 'A URL deve iniciar com http:// ou https://';
        }

        .modal-lexml-emenda-nota-rodape .ql-tooltip[data-mode='link'] input:invalid ~ div.tooltip-invalid-message {
          display: block;
        }
        .d-flex {
          display: flex;
      ...
      <div class="modal-body">
        <div id="editor-lexml-emenda-nota-rodape-container"></div>
      </div>
