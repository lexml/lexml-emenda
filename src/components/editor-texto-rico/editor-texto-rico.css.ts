...
export const editorTextoRicoCss = html`
  <style>
    ...
    .lexml-emenda-editor-texto-rico p:not(.ql-align-rigth, .ql-align-center) {
      text-indent: 3rem;
    }
    .ql-toolbar.ql-snow .ql-formats {
      margin-right: 8px;
    }
    .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip {
    ...
    .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip.ql-editing a.ql-action::after {
      content: 'Salvar';
      margin: 0 !important;
      padding: 0 !important;
    }
    .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip a.ql-action::after {
      display: inline;
      content: 'Editar';
      margin: 0 !important;
      padding: 0 !important;
    ...
    .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip a.ql-remove::before {
      display: inline;
      content: 'Remover';
      margin: 0 !important;
      padding: 0 !important;
    }
    .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip[data-mode='link']::before {
      content: 'Insira o link:';
    }
    .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip::before {
    ...
    @media (max-width: 600px) {
      ...
      .lexml-emenda-editor-texto-rico.ql-snow .ql-tooltip.ql-hidden {
        display: none;
      }
    }

    .lexml-emenda-editor-texto-rico .estilo-ementa {
      text-indent: 0 !important;
      text-align: justify;
      margin-left: 40%;
    }
    .lexml-emenda-editor-texto-rico .estilo-norma-alterada {
      margin-left: 3rem;
    }
    ...
    .lexml-emenda-editor-texto-rico p.ql-text-indent-0px {
      text-indent: 0;
    }
    ...
    .lexml-emenda-editor-texto-rico .ql-tooltip div.tooltip-invalid-message {
      color: red;
      display: none;
      font-family: var(--eta-font-sans);
      font-size: 0.9rem;
    ...
    .lexml-emenda-editor-texto-rico .ql-tooltip[data-mode='link'] div.tooltip-invalid-message::after {
      content: 'A URL deve iniciar com http:// ou https://';
    }

    .lexml-emenda-editor-texto-rico .ql-tooltip[data-mode='link'] input:invalid ~ div.tooltip-invalid-message {
      display: block;
    }

    @-moz-document url-prefix() {
      #lexml-emenda-editor-texto-rico-justificativa-inner > .ql-editor {
