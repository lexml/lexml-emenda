...
@customElement('lexml-emenda-autoria')
export class AutoriaComponent extends LitElement {
  ...
  @queryAll('lexml-emenda-autocomplete')
      ...
      <div class="autoria-grid">
        <div class="autoria-grid--col1">
          ...
          <lexml-emenda-autocomplete
            class="lexml-emenda-autocomplete"
  ...
  private _focarAutocompleteOuCargo(el: EventTarget, index: number, deslocamento: number): void {
    const nodes = (el as HTMLElement).tagName === 'LEXML-EMENDA-AUTOCOMPLETE' ? this._autocompletes : this._inputCargos;
...
declare global {
  interface HTMLElementTagNameMap {
    'lexml-emenda-autoria': AutoriaComponent;
  }
}
