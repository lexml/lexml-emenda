...
@customElement('lexml-emenda-autocomplete')
  ...
  render(): TemplateResult {
    return html`
      <style>
        ...
        .lexml-emenda-autocomplete-input {
          width: 100%;
        }

        @media (max-width: 576px) {
          .lexml-emenda-autocomplete-label {
            width: calc(100% - 2px);
            display: block;
          }
          .lexml-emenda-autocomplete-input {
      ...
      <slot id="dropdown-input">
        <!-- <input id="defaultInput" class="lexml-emenda-autocomplete-input" type="text" placeholder="Parlamentar" .value=${this.value || ''} /> -->
        <sl-input id="defaultInput" class="lexml-emenda-autocomplete-input" type="text" placeholder="" size="small" .value=${this.value || ''}></sl-input>
      </slot>
...
declare global {
  interface HTMLElementTagNameMap {
    'lexml-emenda-autocomplete': LexmlAutocomplete;
  }
}
